    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genome', models.ForeignKey(to='genevieve_client.GenomeReport', on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Variant',
        ...
        migrations.AddField(
            ...
            name='variant',
            field=models.ForeignKey(to='genevieve_client.Variant', on_delete=models.CASCADE),
        ),
        migrations.AddField(
